  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col gap-8 px-5 py-10">
      <section className="rounded-3xl bg-slate-950 p-8 text-white shadow-xl">
        ...
        <h1 className="mt-3 text-4xl font-bold tracking-tight">忘れたころに、ふっと届く。</h1>
        <p className="mt-4 text-slate-300">
          ホーム画面に追加して通知を許可すると、今日のどこかでOTSUGEから小さなお告げが届きます。
        </p>
        ...
        <p className="mt-4 text-sm text-slate-300">
          現在: {subscribed ? "受け取り中" : "未設定"} / iPhoneではSafariからホーム画面に追加して使います。
        </p>
      ...
      <section className="rounded-3xl bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 divide-y divide-slate-100">
          {schedules.length === 0 && <p className="py-8 text-slate-500">今日はまだ静かです。</p>}
